...
- fix for an import-path crash caused by unexpected OCR-mapper/runtime
  exceptions on some real-device screenshots
...
If you already installed `v0.1.0-alpha.2`, install this newer APK over it.
