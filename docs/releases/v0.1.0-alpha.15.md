...
- a fix so the loaded dashboard scrolls normally on phone-sized screens and
  lower graph panels such as `Hero Usage` stay reachable instead of clipping
  below the fold
...
If you already installed `v0.1.0-alpha.14`, install this newer APK over it.
